...
Drop audio files here and TheDawg plays them at three moments:

| Drop this file       | Plays when                                    |
|----------------------|-----------------------------------------------|
| `startup.mp3`        | TheDawg opens                                 |
...
- **Autoplay**: the launcher passes `--autoplay-policy=no-user-gesture-required`
  ...
  clicked anything. If you ever launch TheDawg in a plain Firefox tab, the
  startup sound may stay quiet until you click somewhere — that's a browser
  policy, not a TheDawg bug.
...
- **Reload**: TheDawg reads this directory at boot and after a page refresh
...
You make them, you find them online, you record yourself yelling "DAWG" into
